...
const S = StyleSheet.create({
  ...
  nav:{height:76,width:'94%',maxWidth:760,alignSelf:'center',backgroundColor:'rgba(18,22,30,0.99)',borderWidth:1,borderColor:'#394354',borderRadius:22,flexDirection:'row',alignItems:'center',paddingHorizontal:5,paddingTop:4,paddingBottom:Platform.OS==='android'?14:8,marginBottom:Platform.OS==='android'?18:10,shadowColor:'#000',shadowOpacity:0.35,shadowRadius:12,shadowOffset:{width:0,height:5},elevation:10},
